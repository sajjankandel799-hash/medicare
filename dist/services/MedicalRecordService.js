...
class MedicalRecordService {
    constructor(storage) {
        this.COLLECTION = 'medical-records';
    ...
    async createRecord(data) {
        ...
        const id = (0, idGenerator_1.generateId)('medical-record');
    ...
    async getPatientRecords(patientId) {
        const allRecords = await this.storage.loadAll(this.COLLECTION);
